...
export default function Dashboard() {
  ...
  return (
    <div className="ml-[70px] md:ml-[201px] lg:ml-[401px] xl:ml-[601px] 3xl:ml-[602px] mt-10">
      ...
      <h1 className="text-[32px] md:text-[44px] lg:text-[66px] xl:text-[66px] 2xl:text-[88px] font-bold text-white font-daminga leading-[1.05] md:leading-[1.1] lg:leading-[1.2] xl:leading-[1.2]" style={{fontSize: isWeb && '110px'}}>
